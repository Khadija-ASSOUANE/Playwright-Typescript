/**
 * @file        6_PUT_API_Request.spec.ts
 * @chapter     API Testing and Mocking - PUT API Request
 * @description Demonstrates a full PUT API flow on OrangeHRM: POST to auth
 *              for a token, POST to create a user, then PUT to fully update
 *              that user record.
 *
