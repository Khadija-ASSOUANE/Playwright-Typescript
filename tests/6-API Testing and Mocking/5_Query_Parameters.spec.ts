/**
 * @file        5_Query_Parameters.spec.ts
 * @chapter     API Testing and Mocking - Query Parameters
 * @description Demonstrates GET API requests with query parameters on the
 *              OrangeHRM leave-types endpoint using limit and offset params.
 *
